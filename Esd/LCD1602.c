...
void lcd_wcmd(unchar cmd);		//写入指令到LCD程序
void lcd_wdat(unchar dat);		//写入数据到LCD程序
void lcd_pos (unchar x, bit y);	//LCD数据指针位置程序
